...
import platform
save_path = "/DATA/ymh/rlcl/results/RLnet_auto16_7.pkl" if platform.system() == "Linux" else "C:/유민형/개인 연구/Reinforcement Classification/results/RLnet_auto16_7.pkl"
