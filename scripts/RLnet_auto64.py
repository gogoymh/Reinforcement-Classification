...
class ReinforceNet(nn.Module):
    ...
    def make_layer(self):
        ...
        layer = [nn.LeakyReLU(), nn.Conv2d(3,3,3,1,1,bias=False), nn.BatchNorm2d(3)]
...
'''
import platform
save_path = "/DATA/ymh/rlcl/results/RLnet_auto64.pkl" if platform.system() == "Linux" else "C:/유민형/개인 연구/Reinforcement Classification/results/RLnet_auto64.pkl"
