...
class ReinforceNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out2 = self.bn2(out2)
        out2 = self.relu(out2) + out1
        
        out3 = self.conv3(out2)
        out3 = self.bn3(out3)
        out3 = self.relu(out3) + out2
        
        out4 = self.conv4(out3)
        out4 = self.bn4(out4)
        out4 = self.relu(out4) + out3
        ...
        out6 = self.bn6(out6)
        out6 = self.relu(out6) + out5
        
        out7 = self.conv7(out6)
        out7 = self.bn7(out7)
        out7 = self.relu(out7) + out6
        
        out8 = self.conv8(out7)
        out8 = self.bn8(out8)
        out8 = self.relu(out8) + out7
        
        out9 = self.conv9(out8)
        out9 = self.bn9(out9)
        out9 = self.relu(out9) + out8
        
        out10 = self.conv10(out9)
        out10 = self.bn10(out10)
        out10 = self.relu(out10) + out9
        
        out11 = self.conv11(out10)
        out11 = self.bn11(out11)
        out11 = self.relu(out11) + out10
        ...
        out13 = self.bn13(out13)
        out13 = self.relu(out13) + out12
        
        out14 = self.conv14(out13)
        out14 = self.bn14(out14)
        out14 = self.relu(out14) + out13
        
        out15 = self.conv15(out14)
        out15 = self.bn15(out15)
        out15 = self.relu(out15) + out14
        
        out16 = self.conv16(out15)
        out16 = self.bn16(out16)
        out16 = self.relu(out16) + out15
...
torch.save({'epoch': epoch,
            ...
            'loss': losses[epoch].item()}, "/home/super/ymh/rlcl/results/RLnet_a_L_B.pkl")
